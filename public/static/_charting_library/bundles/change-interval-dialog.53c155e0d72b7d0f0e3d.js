  ...
  [2077],
  {
    ...
    52143: (e) => {
      e.exports = {
        ...
        de: [
          "Geben Sie die Intervall-Nummer für Minuten-Charts ein (z.B. 5, wenn es sich um einen Fünf-Minuten-RealtimeChart handelt). Oder Zahl plus Buchstabe für H (stündlich), D (täglich), W (wöchentlich), M (monatlich) Intervalle (d.h. D oder 2H)",
        ],
    ...
    35668: (e) => {
      e.exports = {
        ...
        de: [
          "Geben Sie die Intervallnummer für Minuten-Charts ein (d.h. 5, wenn es sich um ein Fünf-Minuten-RealtimeChart handeln soll). Oder Nummer und Buchstabe für andere Intervalle: S für 1-Sekunden-RealtimeChart (15S für 15-Sekunden-RealtimeChart, etc.), H (stündliche), D (tägliche), W (wöchentliche), M (monatliche) Intervalle (z.B. D oder 2H)",
        ],
