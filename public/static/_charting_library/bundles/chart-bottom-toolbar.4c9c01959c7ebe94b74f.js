  ...
  [7260],
  {
      ...
      class he extends r.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleClick = () => {
              const { chartWidget: e } = this.context;
              (0, _.trackEvent)("GUI", "RealtimeChart Bottom Toolbar", "go to"),
    ...
    98948: (e) => {
      e.exports = {
        ...
        cs: "Toggle Maximize RealtimeChart",
        de: ["Auf maximierten RealtimeChart umschalten"],
        el: "Toggle Maximize RealtimeChart",
        en: "Toggle Maximize RealtimeChart",
        es: ["Alternar maximizar gráfico"],
        fa: "Toggle Maximize RealtimeChart",
        fr: ["Agrandir le graphique"],
        he_IL: ["החלף לגרף מקסימלי"],
        hu_HU: ["Maximális Chat Kiterjesztése"],
        id_ID: ["Toggle Memperbesar RealtimeChart"],
        it: ["Espandi/riduci grafico"],
        ja: ["チャート最大化切り替え"],
        ko: ["차트최대화토글"],
        ms_MY: ["Carta Memaksimumkan Togol"],
        nl_NL: "Toggle Maximize RealtimeChart",
        pl: ["Maksymalizuj wykres"],
        pt: ["Alternar para gráfico maximizado"],
        ro: "Toggle Maximize RealtimeChart",
