  ...
  [5093],
  {
    ...
    85109: (e, t, s) => {
      ...
      var xe = s(96362),
        ...
        Ne = s(8561),
        Oe = s(18611);
      (0, He.getLogger)("RealtimeChart.LegendWidget");
      ...
      const Gs = Rs;
      var $s = s(93544);
      const js = (0, He.getLogger)("RealtimeChart.LegendWidget"),
        Ys = [
          "TFEXDelayForGuest",
          "MOEXDelayForGuest",
          "CHIXAuDelayForGuest",
        ...
        onShowLegendWidgetContextMenu(e, t) {
          ...
          return (function (e, t, s, i, l, o) {
            ...
            if (
              (a.push(
                new Je.Action({
                  actionId: "RealtimeChart.Legend.ToggleSymbolVisibility",
                  checkable: !0,
              ...
              t.showOpenMarketStatus &&
                ...
                a.push(
                  new Je.Action({
                    actionId: "RealtimeChart.Legend.ToggleOpenMarketStatusVisibility",
                    checkable: !0,
              ...
              a.push(
                new Je.Action({
                  actionId: "RealtimeChart.Legend.ToggleOhlcValuesVisibility",
                  checkable: !0,
              ...
              a.push(
                new Je.Action({
                  actionId: "RealtimeChart.Legend.ToggleBarChangeValuesVisibility",
                  checkable: !0,
              ...
              a.push(
                new Je.Action({
                  actionId: "RealtimeChart.Legend.ToggleVolumeVisibility",
                  checkable: !0,
              ...
              d &&
                a.push(
                  new Je.Action({
                    actionId: "RealtimeChart.Legend.TogglePriceSourceVisibility",
                    checkable: !0,
            ...
            if (
              (e
                ...
                (a.push(
                  new Je.Action({
                    actionId: "RealtimeChart.Legend.ToggleIndicatorTitlesVisibility",
                    checkable: !0,
                ...
                a.push(
                  new Je.Action({
                    actionId: "RealtimeChart.Legend.ToggleIndicatorArgumentsVisibility",
                    checkable: !0,
                ...
                a.push(
                  new Je.Action({
                    actionId: "RealtimeChart.Legend.ToggleIndicatorValuesVisibility",
                    checkable: !0,
            ...
            return (
              t.settings &&
                ...
                a.push(
                  new Je.Action({
                    actionId: "RealtimeChart.Dialogs.ShowGeneralSettings.LegendTab",
                    label: ft,
                    icon: st,
                    statName: "Settings...",
            ...
            this._moreCMShown ||
              (function (e, t, s) {
                ...
                if (e.maximize.visible.value()) {
                  ...
                  i.push(
                    new g.Action({
                      actionId: "RealtimeChart.PaneControls.MaximizePane",
                      icon: S,
                      label: t.value(),
                  ...
                  i.push(
                    new g.Action({
                      actionId: "RealtimeChart.PaneControls.MinimizePane",
                      icon: S,
                      label: t.value(),
                ...
                if (e.collapse.visible.value()) {
                  ...
                  i.push(
                    new g.Action({
                      actionId: "RealtimeChart.PaneControls.CollapsePane",
                      icon: f,
                      label: t.value(),
                ...
                if (e.restore.visible.value()) {
                  ...
                  i.push(
                    new g.Action({
                      actionId: "RealtimeChart.PaneControls.RestorePane",
                      icon: M,
                      label: t.value(),
                ...
                if (e.up.visible.value()) {
                  ...
                  i.push(
                    new g.Action({
                      actionId: "RealtimeChart.PaneControls.MovePaneUp",
                      icon: w,
                      label: t.value(),
                ...
                if (e.down.visible.value()) {
                  ...
                  i.push(
                    new g.Action({
                      actionId: "RealtimeChart.PaneControls.MovePaneDown",
                      icon: y,
                      label: t.value(),
                ...
                if (e.close.visible.value()) {
                  ...
                  i.push(
                    new g.Action({
                      actionId: "RealtimeChart.PaneControls.DeletePane",
                      icon: b,
                      label: t.value(),
