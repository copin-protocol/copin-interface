    ...
    9629: (t, e, o) => {
      ...
      class m extends n.FloatingToolbar {
        ...
        _createHideToolbarAction() {
          return new l.Action({
            actionId: "RealtimeChart.FavoriteDrawingToolsToolbar.Hide",
      ...
      function G(t, e) {
        const i = [
          ...
          n = (function (t, e) {
            ...
            s.length > 0 &&
              i.push(
                new Z.Action({
                  actionId: "RealtimeChart.LineTool.Clone",
                  name: "clone",
                  icon: o(36296),
                  shortcutHint:
            ...
            if (a.length > 0) {
              const e = {
                actionId: "RealtimeChart.Clipboard.CopyLineTools",
                name: "copy",
        ...
        return (
          ...
          i.push(
            ...
            (function (t) {
              return new Z.Action({
                actionId: "RealtimeChart.SelectedObject.Hide",
      ...
      function ot(t) {
        const {
          ...
          h = (0, i.useMemo)(
            () => [
              new Z.Action({
                actionId: "RealtimeChart.LineTool.Toolbar.ChangeLineStyleToSolid",
                icon: Q,
              ...
              new Z.Action({
                actionId: "RealtimeChart.LineTool.Toolbar.ChangeLineStyleToDashed",
                icon: tt,
              ...
              new Z.Action({
                actionId: "RealtimeChart.LineTool.Toolbar.ChangeLineStyleToDotted",
                icon: et,
      ...
      function rt(t) {
        const {
          ...
          c = nt.map(
            (t) =>
              new Z.Action({
                actionId: "RealtimeChart.LineTool.Toolbar.ChangeFontSizeProperty",
                label: t.toString(),
