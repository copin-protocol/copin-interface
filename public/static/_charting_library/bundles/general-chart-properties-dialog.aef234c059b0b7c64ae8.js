  ...
  [7078],
  {
    ...
    74207: (e) => {
      e.exports = {
        ...
        cs: "RealtimeChart settings",
        de: ["RealtimeChart Einstellungen"],
        el: "RealtimeChart settings",
        en: "RealtimeChart settings",
        es: ["Configuración del gráfico"],
        fa: "RealtimeChart settings",
        fr: ["Paramètres du graphique"],
        he_IL: ["הגדרות גרף"],
        hu_HU: "RealtimeChart settings",
        id_ID: ["Pengaturan chart"],
        it: ["Impostazioni grafico"],
        ja: ["チャート設定"],
        ko: ["차트 세팅"],
        ms_MY: ["Tetapan Carta"],
        nl_NL: "RealtimeChart settings",
        pl: ["Ustawienia wykresu"],
        pt: ["Configurações do gráfico"],
        ro: "RealtimeChart settings",
    ...
    40837: (e) => {
      e.exports = {
        ...
        cs: "Do you really want to delete RealtimeChart Template '{name}' ?",
        de: ["Möchten Sie die RealtimeChart-Vorlage '{name}' wirklich löschen?"],
        el: "Do you really want to delete RealtimeChart Template '{name}' ?",
        en: "Do you really want to delete RealtimeChart Template '{name}' ?",
        es: [
          "¿Está seguro de que desea eliminar la plantilla de gráfico '{name}'?",
        ],
        fa: "Do you really want to delete RealtimeChart Template '{name}' ?",
        fr: ['Voulez-vous vraiment supprimer le modèle de graphique "{name}"?'],
        he_IL: ["האם אתה באמת רוצה למחוק את תבנית הגרף '{name}'?"],
        hu_HU: "Do you really want to delete RealtimeChart Template '{name}' ?",
        id_ID: [
          "Apakah anda benar-benar ingin menghapus Template RealtimeChart '{name}' ?",
        ],
        ...
        nl_NL: "Do you really want to delete RealtimeChart Template '{name}' ?",
        pl: ["Czy na pewno chcesz usunąć szablon wykresu „{name}”?"],
        pt: ["Você realmente quer apagar o Template '{name}' do Gráfico?"],
        ro: "Do you really want to delete RealtimeChart Template '{name}' ?",
