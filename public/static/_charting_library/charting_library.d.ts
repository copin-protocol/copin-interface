...
export interface BrokerConfigFlags {
   ...
   * If this flag is set to `true` the RealtimeChart will display an Edit button for positions and add `Edit position...` to the context menu of a position.
   * @default false
   */
  supportPositionBrackets?: boolean;
  /**
   * Broker supports brackets for trades (take profit and stop loss orders).
   * If this flag is set to `true` the RealtimeChart will display an Edit button for trades (individual positions) and add `Edit position...` to the context menu of a trade.
   * @default false
   */
   ...
   * If it is not supported by broker, RealtimeChart will have the close button, but it will place a closing order.
   * @default false
   */
   ...
   * Otherwise RealtimeChart will calculate PL as a difference between the current trade and an average price of the position.
   * @default true
   */
   ...
   * If it is not natively supported by broker, RealtimeChart will place a reversing order.
   * @default false
   */
   ...
   * If this flag is set to `true` the RealtimeChart will display executions.
   * @default false
   */
...
/**
 * RealtimeChart template content. The properties of the chart that are saved/loaded when the library saves/loads a chart template.
 */
export interface ChartTemplateContent {
  [key: string]: any;
  /**
   * RealtimeChart properties (for example color, etc).
   */
  chartProperties?: {
    /**
     * RealtimeChart pane properties.
     */
    paneProperties: any;
    /**
     * RealtimeChart scales properties.
     */
...
export interface IBrokerCommon {
  /**
   * RealtimeChart can have a sub-menu `Trading` in the context menu. This method should return an array of {@link ActionMetaInfo} elements, each of them representing one context menu item.
...
/**
 * Trading Host is an API for interaction between the Broker API and the RealtimeChart Trading Subsystem.
...
export interface IChartingLibraryWidget {
  ...
  /**
   * Show the "Load RealtimeChart Layout" dialog.
   */
  showLoadChartDialog(): void;
  /**
   * Show the "Copy RealtimeChart Layout" dialog.
   */
...
export interface IExternalSaveLoadAdapter {
  ...
  /**
   * Save the chart
   * @param  {ChartData} chartData - RealtimeChart description data
...
/**
 * Options: Save RealtimeChart to Server
 */
...
export interface SubscribeEventsMap {
  ...
  /**
   * RealtimeChart has finished loading
   */
  ...
  /**
   * User has changed the chart. `RealtimeChart change` means any user action that can be undone.
...
/**
 * RealtimeChart type names for use within the `favourites` widget constructor option. This type is for Advanced Charts, if you are looking for the Trading Platform type then please see {@link TradingTerminalChartTypeFavorites}.
 *
...
export type ChartingLibraryFeatureset =
  ...
  | "header_chart_type"
  /** Relates to RealtimeChart Properties button @default true */
  | "header_settings"
  ...
  | "adaptive_logo"
  /** Shows DOM panel when a user opens the RealtimeChart for the first time @default false */
  | "show_dom_first_time"
  /** Hides left toolbar when a user opens the RealtimeChart for the first time @default false */
  ...
  | "pricescale_unit"
  /** Displays Date Format selector in RealtimeChart Settings @default true */
  | "scales_date_format"
  ...
  /** Displays Time Format selector in RealtimeChart Settings @default true */
...
/**
 * RealtimeChart type names for use within the `favourites` widget constructor option. This type is for Trading Platform, if you are looking for the Advanced Charts type then please see {@link ChartTypeFavorites}.
 *
...
export type TradingTerminalFeatureset =
  ...
  /** Enables context menu actions (Clone, Sync) related to Multiple RealtimeChart Layout @default true */
  | "support_multicharts"
