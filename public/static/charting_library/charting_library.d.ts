...
export interface ChartingLibraryWidgetOptions {
	 ...
	 *     return Promise.resolve(`RealtimeChart ${context.chartIndex + 1} of ${context.chartCount}. ${context.chartTypeName} chart of ${context.symbol}.`);
	 * }
	 * ```
	 */
...
export interface CustomFormatters {
	 ...
	 * Note that by declaring this formatter all the default ones defined in RealtimeChart settings/Scales/Date format
...
export interface IChartWidgetApi {
	 ...
	 * or the 'load_line_tools' endpoint of the [RealtimeChart Storage REST API](https://www.tradingview.com/charting-library-docs/latest/saving_loading/#predefined-rest-api).
	 *
	 * This method requires that the [`saveload_separate_drawings_storage`](https://www.tradingview.com/charting-library-docs/latest/customization/Featuresets.md#saveload_separate_drawings_storage) featureset is enabled.
	 */
...
/**
 * RealtimeChart type names for use within the `favorites` Widget Constructor option. This type is for Advanced Charts, if you are looking for the Trading Platform type then please see {@link TradingTerminalChartTypeFavorites}.
 *
...
/**
 * RealtimeChart type names for use within the `favorites` Widget Constructor option. This type is for Trading Platform, if you are looking for the Advanced Charts type then please see {@link ChartTypeFavorites}.
 *
