...
import { useOrderFilledContext } from './useOrderFilledContext'

export function HLDirectionFilterIcon() {
  const { direction, changeDirection } = useOrderFilledContext()
...
export const DIRECTION_OPTIONS = [
  ...
  { value: HlDirectionEnum.LONG_SHORT, label: 'Long > Short' },
  { value: HlDirectionEnum.SHORT_LONG, label: 'Short > Long' },
]
