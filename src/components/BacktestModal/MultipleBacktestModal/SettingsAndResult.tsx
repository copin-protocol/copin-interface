...
import MultipleBackTestResultTable, { TableResultData } from 'components/BacktestResult/MultipleBacktestResultTable'
import ShareBacktestButton from 'components/BacktestResult/ShareBacktestButton'
        ...
        >
          ...
          {!!data.settings && (
            <>
              ...
              <ShareBacktestButton settings={data.settings} protocol={protocol} type="multiple" sort={currentSort} />
            </>
          )}
        </Flex>
      )}
