...
import { stringifyRequestData } from 'components/BacktestModal/helper'
import PickTradersButton from 'components/BacktestPickTradersButton'
import FavoriteButton from 'components/FavoriteButton'
import { AccountCell } from 'components/Tables/TraderListTable/dataConfig'
...
export default function MultipleBackTestResultTable({
  instanceData,
  results,
  settings,
  tradersMapping,
