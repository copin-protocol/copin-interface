...
import { ExternalSource, mobileTableSettings } from 'components/Tables/TraderListTable/dataConfig'
...
export default function TraderListCard({ data, isLoading }: { data: TraderData[] | undefined; isLoading: boolean }) {
