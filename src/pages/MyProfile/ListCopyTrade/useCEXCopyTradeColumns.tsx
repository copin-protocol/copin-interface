...
export default function useCEXCopyTradeColumns({
  onSelect,
  isMutating,
          ...
          {lite && isRunningFn(item.status) && balance != null && balance < item.volume && (
            <>
              ...
              <Tooltip id={tooltipId}>
                <Type.Caption sx={{ maxWidth: 250, textAlign: 'left' }}>
...
export type CopyTradeRenderProps = ReturnType<typeof useCEXCopyTradeColumns>['renderProps']
