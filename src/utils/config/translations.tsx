...
export const HYPERLIQUID_ORDER_STATUS_TRANS: { [key: string]: string } = {
  [HlOrderStatusEnum.OPEN]: 'Open',
  [HlOrderStatusEnum.FILLED]: 'Filled',
  [HlOrderStatusEnum.CANCELED]: 'Canceled',
  [HlOrderStatusEnum.TRIGGERED]: 'Triggered',
  [HlOrderStatusEnum.REJECTED]: 'Rejected',
  // Canceled reasons
  [HlOrderStatusEnum.MARGIN_CANCELED]: 'Canceled',
  [HlOrderStatusEnum.VAULT_WITHDRAWAL_CANCELED]: 'Canceled',
  [HlOrderStatusEnum.OPEN_INTEREST_CAP_CANCELED]: 'Canceled',
  [HlOrderStatusEnum.SELF_TRADE_CANCELED]: 'Canceled',
  [HlOrderStatusEnum.REDUCE_ONLY_CANCELED]: 'Canceled',
  [HlOrderStatusEnum.SIBLING_FILLED_CANCELED]: 'Canceled',
  [HlOrderStatusEnum.DELISTED_CANCELED]: 'Canceled',
  [HlOrderStatusEnum.LIQUIDATED_CANCELED]: 'Canceled',
  [HlOrderStatusEnum.SCHEDULED_CANCEL]: 'Canceled',
  // Rejected reasons
  [HlOrderStatusEnum.TICK_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.MIN_TRADE_NTL_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.PERP_MARGIN_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.REDUCE_ONLY_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.BAD_ALO_PX_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.IOC_CANCEL_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.BAD_TRIGGER_PX_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.MARKET_ORDER_NO_LIQUIDITY_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.POSITION_INCREASE_AT_OPEN_INTEREST_CAP_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.POSITION_FLIP_AT_OPEN_INTEREST_CAP_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.TOO_AGGRESSIVE_AT_OPEN_INTEREST_CAP_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.OPEN_INTEREST_INCREASE_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.INSUFFICIENT_SPOT_BALANCE_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.ORACLE_REJECTED]: 'Rejected',
  [HlOrderStatusEnum.PERP_MAX_POSITION_REJECTED]: 'Rejected',
}
